...
const Settings = () => {
  ...
  return (
          <div className="dark:bg-[#2A2A3B] flex items-center justify-between w-[90%] mt-5   px-4 py-3 rounded-full bg-slate-300 transition-all duration-300 ease-in-out">
                    ...
                    <h1 className="text-lg font-medium dark:text-[#E0E0E0]">Theme</h1> 
                    

                    <label class="inline-flex items-center relative cursor-pointer">
                    <input class=" peer hidden" id="toggle" type="checkbox" checked={darkmode} onChange={()=>setdarkmode(prev=>!prev)}  />
